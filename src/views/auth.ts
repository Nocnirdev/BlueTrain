      ...
      <form id="authForm" class="auth-form" novalidate>
        ...
        <div class="auth-field" id="authPassField">
          ...
          <div class="auth-pass-wrap">
            ...
            <button type="button" class="auth-pass-toggle" id="authPassToggle" aria-label="Mostrar contraseña">
              <svg id="authPassEye" width="18" height="18" viewBox="0 0 24 24" fill="none"
...
function _setupListeners(): void {
  ...
  $maybe('authPassToggle')?.addEventListener('click', () => {
    const input = $maybe<HTMLInputElement>('authPassword');
    const eye   = $maybe('authPassEye');
    if (!input || !eye) return;
    ...
    $maybe('authPassToggle')?.setAttribute('aria-label', show ? 'Ocultar contraseña' : 'Mostrar contraseña');
  });
