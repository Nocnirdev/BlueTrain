/* =====================================================
   BlueTrain — data/workouts.js
   Plan de entrenamiento de 3 mesociclos.
   Fuentes: NSCA, ACSM, formato oficial de carrera funcional.
   ===================================================== */
  ...
  A1: {
    ...
    blocks: [
      ...
      },
      {
        ...
        protocol: {
          name: "3 Rondas · For Time", time: "Descanso 90s entre rondas",
          items: ["400 m carrera @ RPE 7", "20 wall balls (6–9 kg)", "15 burpees", "30s plancha"]
        },
        items: [
      ...
      },
      {
        ...
        protocol: {
          name: "EMOM 6'", time: "Cada minuto, on the minute",
          items: ["Min impar: 12 swings con kettlebell (20 kg)", "Min par: 10 mountain climbers/lado"]
        },
        items: [
  ...
  B1: {
    ...
    blocks: [
      ...
      },
      {
        type: "competition", title: "Bloque Competición", duration: "15 min",
        protocol: {
          name: "AMRAP 15'", time: "As many rounds as possible",
          items: ["500 m remo", "15 burpee broad jump", "20 lunges con mancuernas", "10 renegade rows/lado"]
        },
        items: [
      ...
      },
      {
        type: "finisher", title: "Finisher", duration: "6 min",
        protocol: {
          name: "Intervalos 30/30 · Ski Erg", time: "6 rondas",
          items: ["30s ski erg @ RPE 8 (fuerte)", "30s descanso activo", "Repetir × 6"]
        },
        items: [
  ...
  C1: {
    ...
    blocks: [
      ...
      },
      {
        ...
        protocol: {
          name: "4 Rondas · RPE 7", time: "Descanso 90s entre rondas",
          items: ["12 goblet squats", "8/lado push-up con rotación", "8/pierna KB single-leg deadlift", "8/lado renegade row", "20 m/lado suitcase carry"]
        },
        items: [
      ...
      },
      {
        ...
        protocol: {
          name: "3 Estaciones × 2 Vueltas", time: "Descanso 60s entre estaciones",
          items: [
            "400 m carrera + 50 m sled push (o 30 squat jumps)",
            "400 m carrera + 40 m sled pull (o 20 inverted rows)",
            "400 m carrera + 80 m farmer carry (2×20 kg)"
          ]
        },
        items: [
      ...
      },
      {
        type: "finisher", title: "Finisher", duration: "6 min",
        protocol: {
          name: "AMRAP 6'", time: "Tantas rondas como puedas",
          items: ["10 wall balls", "10 burpees", "200 m carrera"]
        },
        items: [
  ...
  A2: {
    ...
    blocks: [
      ...
      },
      {
        ...
        protocol: {
          name: "4 Rondas · For Time", time: "Descanso 2 min entre rondas",
          items: ["200 m ski erg @ RPE 8–9", "15 wall balls (7–10 kg)", "10 burpee broad jumps"]
        },
        items: [
      ...
      },
      {
        ...
        protocol: {
          name: "EMOM 8'", time: "Alterna cada minuto",
          items: ["Min impar: 20s ski erg sprint + 12 wall balls", "Min par: 15 KB swings (24 kg) + 30s plancha"]
        },
        items: [
  ...
  B2: {
    ...
    blocks: [
      ...
      },
      {
        ...
        protocol: {
          name: "3 Rondas · For Time", time: "Descanso 90s entre rondas",
          items: ["500 m remo @ 1:55–2:05 /500m", "20 sandbag lunges (12–20 kg)", "15 burpee broad jumps"]
        },
        items: [
      ...
      },
      {
        ...
        protocol: {
          name: "Tabata Remo · 4 min", time: "8 rondas de 20s/10s",
          items: ["20s remo al máximo esfuerzo", "10s descanso total", "Repetir 8 veces", "Mantén vatios constantes en todas las rondas"]
        },
        items: [
  ...
  C2: {
    ...
    blocks: [
      ...
      },
      {
        ...
        protocol: {
          name: "2 Vueltas · Race Sim", time: "Descanso 2 min entre vueltas",
          items: [
            "400m carrera + 500m ski erg",
            "400m carrera + 25m sled push (o 20 squat jumps)",
            "400m carrera + 25m sled pull (o 20 inverted rows)",
            "400m carrera + 40m burpee broad jump",
            "400m carrera + 500m remo",
            "400m carrera + 100m farmer carry (2×20–32 kg)",
            "400m carrera + 50m sandbag lunges (12–20 kg)",
            "400m carrera + 50 wall balls (6–9 kg)"
          ]
        },
        items: [
  ...
  A3: {
    ...
    blocks: [
      ...
      },
      {
        ...
        protocol: {
          name: "3 Bloques · Race Pace", time: "Descanso 3 min entre bloques",
          items: [
            "800 m carrera + 500 m ski erg @ race pace",
            "800 m carrera + 25 wall balls (peso competición) + 10 burpee broad jumps",
            "800 m carrera + 100 m farmer carry (peso objetivo)"
          ]
        },
        items: [
      ...
      },
      {
        ...
        protocol: {
          name: "4 × 100 m Strides", time: "Descanso completo entre cada uno",
          items: ["100 m al 85%", "100 m al 90%", "100 m al 95%", "100 m al 100% sprint"]
        },
        items: [
